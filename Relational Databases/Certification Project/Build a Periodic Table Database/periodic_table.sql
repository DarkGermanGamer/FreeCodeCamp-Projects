...
--
-- Name: properties atomic_number__fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomic_number__fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
